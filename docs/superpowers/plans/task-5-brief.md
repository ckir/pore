...
**Interfaces:**
- Consumes: `GenericIndex`, `IndexOptions`, `SearchOptions`, `FieldMap` trait, shared helpers from `tests/common.rs` (created in Task 4)
- Produces: none
...
Run: `cargo test -p pore-core --features vendored generic -- --nocapture`
